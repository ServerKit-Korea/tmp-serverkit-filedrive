/**
 * filedrive/extractor/list/audio.ts
 * [Readme] --------------------------------------------------------------------------------------
 *
 * [audio] 키에 대한 추가적인 메타데이터 추출 클래스가 저장되어 있습니다.
 *
 * -----------------------------------------------------------------------------------------------
 */
...
/**
 * @description * audio 파일에 대한 추가 메타데이터 추출 클래스.
 */
@FileExtractorDecorator("audio")
export class AudioExtractor extends BaseExtractor {
